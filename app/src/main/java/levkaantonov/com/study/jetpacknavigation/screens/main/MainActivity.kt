package levkaantonov.com.study.jetpacknavigation.screens.main
...
import levkaantonov.com.study.jetpacknavigation.databinding.ActivityMainBinding
import levkaantonov.com.study.jetpacknavigation.screens.main.tabs.TabsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun isSignedIn(): Boolean {
        val bundle = intent.extras ?: throw IllegalStateException("No required args")
        return MainActivityArgs.fromBundle(bundle).isSignedIn
    }
